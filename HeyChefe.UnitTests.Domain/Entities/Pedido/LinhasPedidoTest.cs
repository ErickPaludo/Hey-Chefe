...
namespace HeyChefe.UnitTests.Domain.Entities
{
    public class LinhasPedidoTest
    {
        ...
        public void Create_ComDadosValidos_DeveCriarLinhaPedidoComSucesso()
        {
            ...
            // Act
            var linha = LinhasPedido.Create(pedido, item, quantidade, cortesia);
        ...
        {
            // Arrange & Act
            var linha = LinhasPedido.Create(PedidoValido(), ItemValido(), 1, true);
        ...
        {
            // Arrange & Act
            var exception = Record.Exception(() => LinhasPedido.Create(null!, ItemValido(), 1, false));
        ...
        {
            // Arrange & Act
            var exception = Record.Exception(() => LinhasPedido.Create(PedidoValido(), null!, 1, false));
        ...
        {
            // Arrange & Act
            var exception = Record.Exception(() => LinhasPedido.Create(PedidoValido(), ItemValido(), 0, false));
        ...
        {
            // Arrange & Act
            var exception = Record.Exception(() => LinhasPedido.Create(PedidoValido(), ItemValido(), -3, false));
        ...
        {
            // Arrange
            var linha = LinhasPedido.Create(PedidoValido(), ItemValido(), 1, false);
