...
{
    public record SelectPedidos(Guid Id, string NumPedido, string Mesa, ESituacaoPedido Situacao, decimal QuantidadeTotalItens, decimal ValorFinal, CriadorPedidoDTO CriadorPedido, List<LinhaPedidoDTO> LinhasPedido);
